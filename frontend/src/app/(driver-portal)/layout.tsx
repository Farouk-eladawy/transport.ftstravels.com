...
function DriverPortalShell({
  ...
  const tabs = [
    { href: "/driver", label: t("portal.jobs"), icon: Briefcase, exact: true },
    { href: "/driver/history", label: t("portal.history"), icon: History },
    { href: "/driver/profile", label: t("portal.settings"), icon: Settings },
  ];
